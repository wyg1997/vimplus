...
function compile_vim_on_ubuntu()
{
    ...
    apt-get install -y libncurses5-dev libncurses5 libgnome2-dev libgnomeui-dev \
...
function compile_vim_on_debian()
{
    ...
    apt-get install -y libncurses5-dev libncurses5 libgtk2.0-dev libatk1.0-dev libcairo2-dev libx11-dev libxpm-dev libxt-dev python-dev python3-dev ruby-dev lua5.1 lua5.1-dev
...
function install_prepare_software_on_ubuntu()
{
    ...
    apt-get install -y exuberant-ctags build-essential python python-dev python3-dev fontconfig curl libfile-next-perl ack-grep git
...
{
    apt-get update
    apt-get install -y cmake exuberant-ctags build-essential python python-dev python3-dev fontconfig curl libfile-next-perl ack-grep git
    compile_vim_on_ubuntu
}
...
{
    apt-get update
    apt-get install -y cmake exuberant-ctags build-essential python python-dev python3-dev fontconfig curl libfile-next-perl ack git
...
function install_prepare_software_on_centos()
{
    ...
    if [ $version -ge 8 ];then
        ...
        dnf install -y vim ctags automake gcc gcc-c++ kernel-devel make cmake python2 python2-devel python3-devel curl fontconfig ack git
    else
        yum install -y ctags automake gcc gcc-c++ kernel-devel cmake python-devel python3-devel curl fontconfig ack git
...
{
    dnf install -y vim ctags automake gcc gcc-c++ kernel-devel cmake python-devel python3-devel curl fontconfig ack git
}

# 安装archlinux必备软件
function install_prepare_software_on_archlinux()
{
    pacman -S --noconfirm vim ctags automake gcc cmake python3 python2 curl ack git fontconfig
...
{
    zypper install -y vim ctags gcc gcc-c++ cmake python-devel python3-devel curl ack fontconfig git ncurses5-devel
}
